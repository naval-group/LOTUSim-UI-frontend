...
import { MatrixInput, identity6x6 } from '../../common/Panels';
...
export const XdynBasePanel: React.FC<XdynBasePanelProps> = ({
  xdynBaseParams,
  setXdynBaseParams,
}) => {
  ...
  return (
    <Box>
      ...
      <Typography variant="subtitle1" mt={2}>
        Body Frame Relative To Mesh Frame
      </Typography>
      ...
      <Typography variant="subtitle1" mt={2}>
        Hydro Forces Calculation Point
      </Typography>
      <Box display="flex" gap={1}>
        {(['x', 'y', 'z'] as const).map((axis) => (
          <TextField
      ...
      <Typography variant="subtitle1" mt={2}>
        Resistance Curve Speed (comma separated)
      </Typography>
      <TextField
      ...
      <Typography variant="subtitle1" mt={2}>
        Resistance Curve Resistance (comma separated)
      </Typography>
      <TextField
