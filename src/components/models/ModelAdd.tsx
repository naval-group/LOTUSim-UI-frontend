 ...
 *    - Control surfaces (ControlSurfacePanel)
...
import { ControlSurface, ControlSurfacePanel } from './xdyn/ControlSurfaces';
import { parseMatrix } from '../common/Panels';

interface AddModelDialogProps {
  open: boolean;
  onClose: () => void;
  onSave: (data: Record<string, unknown>, stlFile: File, image: File) => void;
}
...
export const AddModelDialog: React.FC<AddModelDialogProps> = ({ open, onClose, onSave }) => {
  ...
  const [controlSurfaces, setControlSurfaces] = useState<ControlSurface[]>([]);
      ...
      xdyn: useXdyn
        ? {
            ...
            rudders: controlSurfaces.map((r) => ({
              ...
              takeWavesOrbitalVelocityIntoAccount: r.takeWavesOrbitalVelocityIntoAccount,
            })),
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      >
        ...
        <FormControlLabel
          control={<Checkbox checked={useXdyn} onChange={(e) => setUseXdyn(e.target.checked)} />}
          label="Use xdyn"
        />
        {open && useXdyn && (
          <>
            <XdynBasePanel xdynBaseParams={xdynBaseParams} setXdynBaseParams={setXdynBaseParams} />
            <PropellerPanel propellers={propellers} setPropellers={setPropellers} />
            ...
            <ControlSurfacePanel
              ...
              setControlSurfaces={setControlSurfaces}
            />
          </>
        )}
      </DialogContent>
